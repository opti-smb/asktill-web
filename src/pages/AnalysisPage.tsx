          ...
          <div className={styles.card}>
            <div className={styles.scrollViewport}>
              ...
              <div className={styles.encryptBanner}>
                <span className={styles.encryptIcon} aria-hidden>
                  <i className="ti ti-shield-lock" />
                </span>
                <div className={styles.encryptCopy}>
                  <div className={styles.encryptTitle}>All data stays encrypted.</div>
                  <p className={styles.encryptBody}>
                    Statements are encrypted in transit and at rest (AES-256). Sensitive payment
                    details are tokenized — AskTill never stores raw card numbers.
                  </p>
                </div>
              </div>
            </div>
